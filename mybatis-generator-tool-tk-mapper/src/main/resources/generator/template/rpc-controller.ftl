package ${basePackage}.controller.rpc;
...
@Api(value = "RPC WEB - Rpc${modelNameUpperCamel}Controller", description = " XXX ", produces = MediaType
.APPLICATION_JSON_UTF8_VALUE)
public class Rpc${modelNameUpperCamel}Controller extends BaseController {
    @Autowired
