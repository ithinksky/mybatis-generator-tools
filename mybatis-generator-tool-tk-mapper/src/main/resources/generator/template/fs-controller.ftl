...
@Api(value = "Frontend Web - Frontend${modelNameUpperCamel}Controller", description = " XXX ", produces = MediaType
.APPLICATION_JSON_UTF8_VALUE)
public class Frontend${modelNameUpperCamel}Controller extends BaseController {
    @Autowired
